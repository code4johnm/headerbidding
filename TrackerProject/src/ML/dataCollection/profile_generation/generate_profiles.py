    ...
    def __init__(self, **kwargs):
        ...
        for sample in iter(range(1, samples_to_generate)):
            ...
            if sample % print_every == 0:
                print(
                    "Gen'd {} profiles in {:.4f} sec. - split time: {:.4f} sec.".format(
                        profiles_completed,
                        time.time() - startTime,
                ...
                profile.to_csv(
                    "generatedProfiles.csv", index=False, mode="a", header=False
                )
        ...
        print(
            "Time to generate {} profiles {:.4f} sec.".format(
                samples_to_generate, time.time() - startTime
            )
        )
